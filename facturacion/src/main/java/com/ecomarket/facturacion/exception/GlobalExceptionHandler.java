...
public class GlobalExceptionHandler {
    ...
    // Captura IllegalStateException (como "No existe el producto")
    ...
    public ResponseEntity<Object> handleNotFound(HttpClientErrorException.NotFound ex) {
        return buildResponse(HttpStatus.NOT_FOUND, "No existe el producto");
    }
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex) {
        String message = "Error de formato en los datos enviados. Verifica los tipos (ej: cantidad debe ser número).";
